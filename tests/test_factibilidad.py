...
class TestFactibilidadOrquestador:
    def ejecutar_y_validar_factibilidad(self, orquestador_context, config_data, valor_esperado):
        queue, manual_interruption, EXECUTION_TIME = orquestador_context

        objective_value, rebanadas_activas = orquestador(
            queue,
            manual_interruption,
            EXECUTION_TIME,
            time.time(),
        ...
        assert objective_value == valor_esperado
    ...
    def test_factibilidad_caso_1(self, orquestador_context):
        ...
        self.ejecutar_y_validar_factibilidad(orquestador_context, config_data, valor_esperado=4)
    ...
    def test_factibilidad_caso_nuevo_optimo_6(self, orquestador_context):
        ...
        self.ejecutar_y_validar_factibilidad(orquestador_context, config_data, valor_esperado=6)
    ...
    def test_factibilidad_caso_4(self, orquestador_context):
        ...
        self.ejecutar_y_validar_factibilidad(orquestador_context, config_data, valor_esperado=3)
    ...
    def test_factibilidad_caso_6(self, orquestador_context):
        ...
        self.ejecutar_y_validar_factibilidad(orquestador_context, config_data, valor_esperado=25)
    ...
    def test_factibilidad_caso_7(self, orquestador_context):
        ...
        self.ejecutar_y_validar_factibilidad(orquestador_context, config_data, valor_esperado=7)
    ...
    def test_factibilidad_caso_8(self, orquestador_context):
        ...
        self.ejecutar_y_validar_factibilidad(orquestador_context, config_data, valor_esperado=16)
    ...
    def test_factibilidad_caso_9(self, orquestador_context):
        ...
        self.ejecutar_y_validar_factibilidad(orquestador_context, config_data, valor_esperado=13)
    ...
    def test_factibilidad_caso_10(self, orquestador_context):
        ...
        self.ejecutar_y_validar_factibilidad(orquestador_context, config_data, valor_esperado=15)
    ...
    def test_factibilidad_caso_12(self, orquestador_context):
        ...
        self.ejecutar_y_validar_factibilidad(orquestador_context, config_data, valor_esperado=18)
    ...
    def test_factibilidad_caso_13(self, orquestador_context):
        ...
        self.ejecutar_y_validar_factibilidad(orquestador_context, config_data, valor_esperado=12)
    ...
    def test_factibilidad_caso_16(self, orquestador_context):
        ...
        self.ejecutar_y_validar_factibilidad(orquestador_context, config_data, valor_esperado=24)
    ...
    def test_factibilidad_caso_17(self, orquestador_context):
        ...
        self.ejecutar_y_validar_factibilidad(orquestador_context, config_data, valor_esperado=20)
    ...
    def test_factibilidad_caso_18(self, orquestador_context):
        ...
        self.ejecutar_y_validar_factibilidad(orquestador_context, config_data, valor_esperado=50)
